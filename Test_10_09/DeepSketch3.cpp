...
struct Kernel { 
	...
	Kernel(int x) { 
		...
		if (x == 5) {
			...
			gamma[0][0] = -2; gamma[0][1] = -1; gamma[0][2] = 0; gamma[0][3] = 1; gamma[0][4] = 2; 
			gamma[1][0] = -2; gamma[1][1] = -4; gamma[1][2] = 0; gamma[1][3] = 4; gamma[1][4] = 2; 
			gamma[2][0] = -2; gamma[2][1] = -4; gamma[2][2] = 0; gamma[2][3] = 4; gamma[2][4] = 2; 
			gamma[3][0] = -2; gamma[3][1] = -4; gamma[3][2] = 0; gamma[3][3] = 4; gamma[3][4] = 2; 
			gamma[4][0] = -2; gamma[4][1] = -1; gamma[4][2] = 0; gamma[4][3] = 1; gamma[4][4] = 2; 
		}
	}
};
